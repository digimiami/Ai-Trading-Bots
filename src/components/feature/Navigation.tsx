...
export default function Navigation() {
  ...
  const authRequiredRoutes = ['/dashboard', '/bots', '/settings', '/admin', '/trades', '/positions', '/performance', '/pablo-ready', '/ai-assistant', '/backtest', '/winners', '/bot-activity', '/transaction-log', '/paper-trading', '/futures-pairs-finder', '/messages'];
