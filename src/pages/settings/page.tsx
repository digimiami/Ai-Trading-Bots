    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="pt-20 pb-20 px-4 space-y-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-gray-500 text-sm mb-4">Configure AI Assistant preferences and features</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-1">
                  <i className="ri-mic-line text-xl text-blue-600"></i>
                  <h4 className="font-medium text-gray-900">Voice Chat</h4>
                </div>
                <p className="text-sm text-gray-500">Enable voice interaction with the AI Assistant</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={aiAssistantSettings.voiceChatEnabled}
                  onChange={(e) => {
                    const newSettings = { ...aiAssistantSettings, voiceChatEnabled: e.target.checked };
                    setAiAssistantSettings(newSettings);
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Allow uploading documents for AI analysis</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={aiAssistantSettings.documentAnalysisEnabled}
                  onChange={(e) => {
                    const newSettings = { ...aiAssistantSettings, documentAnalysisEnabled: e.target.checked };
                    setAiAssistantSettings(newSettings);
                    localStorage.setItem('ai_assistant_settings', JSON.stringify(newSettings));
                  }}
                  className="sr-only peer"
