import{u as q,r as a,s as l}from"./index-083772a1.js";function E(){const{user:e}=q(),[n,u]=a.useState([]),[r,o]=a.useState([]),[c,m]=a.useState(null),[_,f]=a.useState(!0),[g,p]=a.useState(null),S=async()=>{const{data:s,error:t}=await l.from("course_modules").select(`
          id,
          title,
          slug,
          audience,
