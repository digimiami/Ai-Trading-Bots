...
-- Add final comprehensive tests to each module
INSERT INTO public.module_lessons (module_id, title, slug, type, content_md, media_url, order_index)
SELECT 
  cm.id,
  'Final Module Test',
  ...
  'quiz',
  CASE cm.slug
    WHEN 'orientation-setup' THEN
      '{"questions":[{"question":"What is the recommended minimum paper trading period before going live?","options":["1 week","2-4 weeks","1 month","3 months"],"correctIndex":1},{"question":"What percentage of profits should you expect to lose due to fees and slippage in real trading?","options":["5-10%","10-20%","20-30%","30-40%"],"correctIndex":1},{"question":"Which security practice is most critical for API keys?","options":["Store in browser","Use read-only keys when possible","Share with team","Never rotate"],"correctIndex":1},{"question":"What is the main difference between paper and real trading execution?","options":["Paper uses fake prices","Real trading has fees and slippage","Paper trading is slower","Real trading uses different strategies"],"correctIndex":1},{"question":"What should you do first when switching from paper to real trading?","options":["Use full capital immediately","Start with 10-25% of intended capital","Copy all paper trades exactly","Ignore fees"],"correctIndex":1}]}'
    WHEN 'platform-deep-dive' THEN
      '{"questions":[{"question":"Which component evaluates trades before execution?","options":["Signal Generator","Risk Engine","Execution Layer","Monitoring System"],"correctIndex":1},{"question":"What is the purpose of drawdown limits?","options":["Increase profits","Protect capital","Speed up trading","Reduce fees"],"correctIndex":1},{"question":"Where do you configure alert channels?","options":["Bot Settings","Monitoring & Alerts","Exchange Settings","Strategy Config"],"correctIndex":1},{"question":"What does PnL stand for?","options":["Profit and Loss","Price and Liquidity","Position and Leverage","Portfolio Limits"],"correctIndex":0},{"question":"What is the recommended approach for setting position limits?","options":["No limits","Set maximum exposure per strategy","Unlimited per asset","Only limit total portfolio"],"correctIndex":1}]}'
    WHEN 'crypto-foundations' THEN
      '{"questions":[{"question":"What is the recommended risk per trade percentage?","options":["0.5-1%","1-2%","3-5%","5-10%"],"correctIndex":1},{"question":"What does ATR measure?","options":["Price direction","Market volatility","Volume","Liquidity"],"correctIndex":1},{"question":"What is the main purpose of position sizing?","options":["Maximize profits","Manage risk","Increase trades","Reduce fees"],"correctIndex":1},{"question":"What is slippage?","options":["Trading fees","Difference between expected and actual price","Exchange downtime","Order delays"],"correctIndex":1},{"question":"What is the key psychological challenge in real trading?","options":["Technical analysis","Emotional discipline","Market timing","Strategy selection"],"correctIndex":1}]}'
    WHEN 'strategy-development' THEN
      '{"questions":[{"question":"What is the main risk of overfitting in backtesting?","options":["Strategy only works on historical data","Strategy is too simple","Strategy uses too many indicators","Strategy executes too fast"],"correctIndex":0},{"question":"Which metric measures risk-adjusted returns?","options":["Total Return","Win Rate","Sharpe Ratio","Maximum Drawdown"],"correctIndex":2},{"question":"What is look-ahead bias?","options":["Using future data in past decisions","Looking at too many charts","Trading too frequently","Ignoring stop losses"],"correctIndex":0},{"question":"What is the purpose of walk-forward analysis?","options":["Test on rolling time windows","Optimize all parameters","Increase backtest speed","Reduce trading fees"],"correctIndex":0},{"question":"What should you optimize in a strategy?","options":["Everything","Core strategy logic only","Entry/exit parameters","Nothing"],"correctIndex":2}]}'
    WHEN 'risk-management' THEN
      '{"questions":[{"question":"What does a correlation of -1 mean?","options":["Perfect positive correlation","Perfect negative correlation","No correlation","High volatility"],"correctIndex":1},{"question":"What is the recommended maximum drawdown limit?","options":["5-10%","10-20%","20-30%","30-40%"],"correctIndex":2},{"question":"Why is diversification important?","options":["Increases returns","Reduces overall risk","Simplifies trading","Reduces fees"],"correctIndex":1},{"question":"What should you do during a drawdown?","options":["Increase position sizes","Reduce position sizes","Stop all trading","Ignore it"],"correctIndex":1},{"question":"What is risk budgeting?","options":["Spending on risk tools","Allocating risk limits across strategies","Budgeting for losses","Risk-free trading"],"correctIndex":1}]}'
    WHEN 'ai-machine-learning' THEN
      '{"questions":[{"question":"What is supervised learning?","options":["Learning without labels","Learning with labeled data","Learning through trial and error","Learning from clustering"],"correctIndex":1},{"question":"What should you set for ML prediction confidence?","options":["As low as possible","50% minimum","High threshold (70%+)","100% always"],"correctIndex":2},{"question":"What is model drift?","options":["Model moving slowly","Model performance degrading over time","Model being too fast","Model using too much data"],"correctIndex":1},{"question":"What is the recommended approach when starting with AI optimization?","options":["Fully automated","Manual approval","No optimization","Random changes"],"correctIndex":1},{"question":"What features are used in ML for trading?","options":["Only price","RSI, EMA, ATR, Volume","Only volume","Only technical indicators"],"correctIndex":1}]}'
    WHEN 'advanced-techniques' THEN
      '{"questions":[{"question":"What is HTF bias?","options":["Trading against the trend","Trading only in higher timeframe trend direction","Using only high timeframes","Ignoring trends"],"correctIndex":1},{"question":"What is pairs trading?","options":["Trading two assets together","Trading price divergence between correlated assets","Trading only pairs","Trading with a partner"],"correctIndex":1},{"question":"What market condition is best for grid trading?","options":["Strong trends","Range-bound markets","High volatility only","Low liquidity"],"correctIndex":1},{"question":"What is required for arbitrage?","options":["Slow execution","High transaction costs","Fast execution","Large spreads"],"correctIndex":2},{"question":"What is the benefit of multi-timeframe analysis?","options":["More trades","Better context and trade quality","Faster execution","Lower fees"],"correctIndex":1}]}'
  END,
  null,
  (SELECT COALESCE(MAX(order_index), 0) + 1 FROM public.module_lessons WHERE module_id = cm.id)
FROM public.course_modules cm
WHERE cm.slug IN ('orientation-setup', 'platform-deep-dive', 'crypto-foundations', 'strategy-development', 'risk-management', 'ai-machine-learning', 'advanced-techniques')
ON CONFLICT (module_id, slug) DO NOTHING;
